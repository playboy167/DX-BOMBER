...
def update():
    ...
    os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/playboy167/DX-BOMBER > /dev/null 2>&1")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : DX-NOOB                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/playboy167 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : DX-NOON BOSS 😈🔥              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
